            ...
            <div className='container mx-auto px-8 md:px-16 lg:px-24'>
                ...
                <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                    <div className='flex-0'>
                        ...
                        <FaEnvelope className="inline-block text-green-400 mr-3" />
                            <a href="mailto:prasathnantha10@gmail.com" className='hover:underline'>
                            prasathnantha10@gmail.com
                            </a>
                        </div>
                        <div className='mb-4 mt-8'>
                            <FaPhone className="inline-block text-green-400 mr-2"></FaPhone>
                            <span>+91 9360051542</span>
                        </div>
                        <div className='mb-4 mt-8'>
                            <FaMapMarkedAlt className="inline-block text-green-400 mr-2"></FaMapMarkedAlt>
                            <span>10 Nehruji Street, Ilayangudi - 630702, Sivagangai District</span>
                        </div>
                    </div>
